local function Register()
	...
	do
		...
		local setting = Settings.RegisterProxySetting(category, "PROXY_SICKNESS", Settings.DefaultVarLocation,
			Settings.VarType.Number, MOTION_SICKNESS_CHECKBOX, defaultValue, GetValue, SetValue);
		Settings.CreateDropDown(category, setting, GetOptions, OPTION_TOOLTIP_MOTION_SICKNESS_CHECKBOX);
	end
